...
const SignUp = ({ navigation }) => {
  ...
  const [selectedMode, setSelectedMode] = useState(
    mode.filter((a) => a.name == 'Customer')[0]
  );
  ...
  function renderLogo() {
    return (
      ...
      >
        ...
        <Text
          style={{ ...FONTS.largeTitle, fontSize: 45, color: COLORS.primary }}
        >
          Treats
        </Text>
      </View>
    ...
    return (
      ...
      >
        <View style={{ marginTop: SIZES.padding * 3 }}>
          <Text style={{ color: COLORS.lightGreen, ...FONTS.body2 }}>
            Phone number
          </Text>
          <TextInput
            style={{
  ...
  return (
    ...
    >
      <LinearGradient colors={[COLORS.black, COLORS.black]} style={{ flex: 1 }}>
        <ScrollView>
          {renderLogo()}
          {renderForm()}
          {renderButton()}
