...
//Screen where customer selects food item to order
            ...
            <View style={{ height: SIZES.height * 0.35 }}>
              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() =>
                    editOrder('-', item.menuId, item.price, item.name)
                  }
                >
          ...
          <View style={{ flex: 1, flexDirection: 'column-reverse' }}>
            ...
            >
              ...
              >
                ...
                >
                  But don't worry! It'll be refunded as soon as you'll return
                  the package.{' '}
                </Text>
                <Text
                  style={{
                ...
                >
                  You'll also be rewarded with Uber vouchers and cashbacks
                  coupons for being a part of our Green Initiative!
                </Text>
                <View
                  style={{
                    flex: 1,
