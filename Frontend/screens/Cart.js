  ...
  function renderInfo() {
    return (
      <View style={{ margin: SIZES.padding * 2, marginBottom: SIZES.padding }}>
        ...
        >
          Delivery Time: {restaurant?.duration}
        </Text>
        ...
        <Text style={{ color: COLORS.white, ...FONTS.body3 }}>
          Phone Number : {global.user.phoneNo}
        </Text>
        <Text
          style={{
    ...
    const renderItem = ({ item }) => (
      ...
      >
        <View style={{ flexDirection: 'row' }}>
          ...
          >
            {restaurant['menu'].filter((a) => a.menuId === item.menuId)[0].name}
          </Text>
          <Text
            style={{
              width: '35%',
        ...
        >
          <View style={{ flex: 1, flexDirection: 'column-reverse' }}>
            ...
            >
              ...
              >
                Our delivery executive will be at your doorstep in{' '}
                {restaurant?.duration}.
              </Text>
            </View>
          </View>
